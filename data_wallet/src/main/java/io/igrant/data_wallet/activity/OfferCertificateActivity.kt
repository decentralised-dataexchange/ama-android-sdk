...
import io.igrant.data_wallet.models.certificateOffer.OfferData
import io.igrant.data_wallet.models.certificateOffer.RequestOffer
    ...
    class RequestCertificateTask(
        ...
        override fun doInBackground(vararg p0: Void?): Void? {
            ...
            try {
                ...
                val thread = io.igrant.data_wallet.models.credentialExchange.Thread()
