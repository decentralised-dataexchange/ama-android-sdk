...
//                    ).show()
    ...
    private fun initLibIndy() {
        ...
        }, activity!!.applicationContext).execute()
    }
    ...
    private fun loadPool() {
        ...
        }, LedgerNetworkType.getSelectedNetwork(context)).execute()
    }
        ...
        ApiManager.api.getService()?.postDetails(typedBytes)
                ?.enqueue(object : Callback<ResponseBody> {
                    ...
                    override fun onResponse(
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            Log.d(InitializeActivity.TAG, "unPackMessage: ${response.body()!!.byteStream()}")
